    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(request ->
                    request.requestMatchers("/register", "/login", "/").permitAll() //allows access to these three endpoints
                ...
                .formLogin(form -> form
                        ...
                        .defaultSuccessUrl("/") //redirects to landing page after successful login
